...
public class FileInfoSignature {
    ...
    // FIRMA: Firmar un documento
    public static final int SIGN_OPERATION_SIGN = 0;
    // COFIRMA: Firmar al mismo nivel que otros
    public static final int SIGN_OPERATION_COSIGN = 1;
    // CONTRAFIRMA: Firmar para certificar otras firmas
     ...
     * @deprecated
     * Usar {@link FileInfoSignature#SIGN_MODE_ATTACHED_ENVELOPED}
     */
    @Deprecated
    public static final int SIGN_MODE_IMPLICIT = SIGN_MODE_ATTACHED_ENVELOPED; // 0;
     ...
     * Usar {@link FileInfoSignature#SIGN_MODE_DETACHED}
     */
    @Deprecated
    public static final int SIGN_MODE_EXPLICIT = SIGN_MODE_DETACHED; // 1;

    // ================ Ubicació de la taula de firmes dins de les firmes PAdES
     ...
     */
    @Deprecated
    public FileInfoSignature(String signID, File fileToSign, String mimeType, String name, String reason,
            String location, String signerEmail, int signNumber, String languageSign, String signType,
            ...
            SecureVerificationCodeStampInfo secureVerificationCodeStampInfo, boolean userRequiresTimeStamp,
     ...
     * Constructor complet.
     */
    public FileInfoSignature(String signID, File fileToSign, File previusSignatureDetachedFile, String mimeType,
            String name, String reason, String location, String signerEmail, int signNumber, String languageSign,
            int signOperation, String signType, String signAlgorithm, int signMode, int signaturesTableLocation,
            SignaturesTableHeader signaturesTableHeader, PdfVisibleSignature pdfVisibleSignature,
            SecureVerificationCodeStampInfo secureVerificationCodeStampInfo, boolean userRequiresTimeStamp,
    ...
    public void setSecureVerificationCodeStampInfo(SecureVerificationCodeStampInfo secureVerificationCodeStampInfo) {
        this.secureVerificationCodeStampInfo = secureVerificationCodeStampInfo;
    }
