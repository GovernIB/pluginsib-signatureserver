...
import es.gob.afirma.transformers.ParserParameterProperties;
 ...
 * @version 1.1, 18/04/2022.
 */
public final class TransformersFacadeServerPlugin {

    /**
     *  Attribute that represents the object that manages the log of the class.
     */
    private static final Logger LOGGER = Logger.getLogger(TransformersFacadeServerPlugin.class);

    /**
     * Attribute that represents the unique instance of the class. 
     */
    private static TransformersFacadeServerPlugin instance;
     ...
     */
    public static TransformersFacadeServerPlugin getInstance(String transformersTemplatesPath) {
        instance = new TransformersFacadeServerPlugin(transformersTemplatesPath);
        return instance;
    }
     ...
     */
    private TransformersFacadeServerPlugin(String transformersTemplatesPath) {
        
        System.setProperty("integra.config", transformersTemplatesPath);
        
        transformersProperties = TransformersProperties.getTransformersProperties();
        
        transformersProperties.put("TransformersTemplatesPath",transformersTemplatesPath);
     ...
     */
    public Document getXmlRequestFileByRequestType(String serviceReq, String method, String type, String version)
            throws TransformersException {
        File xmlFile;
        String fileName, xmlTemplateFolder;
        Document res = null;
        if (!GenericUtilsCommons.assertStringValue(serviceReq) || !GenericUtilsCommons.assertStringValue(type)
                || !GenericUtilsCommons.assertStringValue(version) || !GenericUtilsCommons.assertStringValue(method)) {
            String errorMsg = Language.getResIntegra(ILogConstantKeys.TF_LOG003);
            LOGGER.error(errorMsg);
            throw new TransformersException(errorMsg);
        }
        LOGGER.debug(Language.getFormatResIntegra(ILogConstantKeys.TF_LOG004,
                new Object[] { serviceReq, method, type, version }));
        ...
        try {
            ...
            xmlTemplateFolder = transformersProperties
                    .getProperty(TransformersConstants.TRANSFORMERS_TEMPLATES_PATH_PROPERTIES) + "/xmlTemplates";
            ...
            LOGGER.debug(Language.getFormatResIntegra(ILogConstantKeys.TF_LOG006,
                    new Object[] { res.getDocumentElement().getTagName() }));
        } catch (IOException e) {
     ...
     * @throws TransformersException If the method fails.
     */
    public Document getParserTemplateByRequestType(String serviceReq, String method, String version)
            throws TransformersException {
        File xmlFile;
        String fileName, xmlTemplateFolder;
        Document res = null;

        LOGGER.debug(Language.getFormatResIntegra(ILogConstantKeys.TF_LOG009,
                new Object[] { serviceReq, method, TransformersConstants.PARSER_CTE, version }));

        try {
            fileName = transformersProperties.getProperty(serviceReq + "." + method + "." + version + "."
                    + TransformersConstants.PARSER_CTE + "." + TransformersConstants.TEMPLATE_CTE);
            LOGGER.debug(Language.getFormatResIntegra(ILogConstantKeys.TF_LOG005, new Object[] { fileName }));

            xmlTemplateFolder = transformersProperties
                    .getProperty(TransformersConstants.TRANSFORMERS_TEMPLATES_PATH_PROPERTIES) + "/parserTemplates";
     ...
     * @throws TransformersException If the method fails.
     */
    public String generateXml(Map<String, Object> parameters, String service, String version)
            throws TransformersException {
     ...
     * @throws TransformersException If the method fails.
     */
    public String generateXml(Map<String, Object> parameters, String service, String method, String version)
            throws TransformersException {
        Class<?> transformerClass;
        if (parameters == null || !GenericUtilsCommons.assertStringValue(service)
                || !GenericUtilsCommons.assertStringValue(version) || !GenericUtilsCommons.assertStringValue(method)) {
            String errorMsg = Language.getResIntegra(ILogConstantKeys.TF_LOG003);
            LOGGER.error(errorMsg);
            throw new TransformersException(errorMsg);
        ...
        try {
            ...
            transformerClass = XmlTransformersFactory.getXmlTransformer(service, method,
                    TransformersConstants.REQUEST_CTE, version);
            res = (String) invokeCommonXmlTransf(transformerClass, parameters, service, method,
                    TransformersConstants.REQUEST_CTE, version);
        } catch (Exception e) {
            LOGGER.error(e);
     ...
     * @throws TransformersException If the method fails.
     */
    public Map<String, Object> parseResponse(String response, String service, String version)
            throws TransformersException {
    ...
    public Map<String, Object> parseResponse(String response, String service, String method, String version)
            throws TransformersException {
        Class<Object> transformerClass;
        Map<String, Object> res;

        res = null;
        if (!GenericUtilsCommons.assertStringValue(response) || !GenericUtilsCommons.assertStringValue(service)
                || !GenericUtilsCommons.assertStringValue(version) || !GenericUtilsCommons.assertStringValue(method)) {
            String errorMsg = Language.getResIntegra(ILogConstantKeys.TF_LOG003);
            LOGGER.error(errorMsg);
            throw new TransformersException(errorMsg);
     ...
     * @throws TransformersException If the method fails.
     */
    private Object invokeCommonXmlTransf(Class<?> transformerClass, Map<String, Object> parameters, String service,
            String methodWS, String type, String version) throws TransformersException {
     ...
     */
    @SuppressWarnings({ "unchecked", "rawtypes" })
    private Object invokeParseTransf(String response, Class<Object> transformerClass, String service,
            String methodParam, String version) throws TransformersException {
