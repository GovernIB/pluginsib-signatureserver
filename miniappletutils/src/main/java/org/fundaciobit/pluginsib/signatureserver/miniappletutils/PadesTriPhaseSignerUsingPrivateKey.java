 ...
 * 17 abr 2026 9:17:19
 */
public class PadesTriPhaseSignerUsingPrivateKey extends AbstractPadesTriPhaseSigner {

    private final PrivateKey privateKey;

    public PadesTriPhaseSignerUsingPrivateKey(PrivateKey privateKey, CommonInfoSignature commonInfoSignature,
