...
public class AfirmaServerSignatureServerPlugin extends AbstractSignatureServerPlugin {
    ...
    */
    ...
    private org.fundaciobit.pluginsib.signatureserver.afirmaserver.validarfirmaapi.DSSSignature apiUpgrade;
    ...
    public byte[] upgradeSignature(byte[] signature, byte[] targetCertificate, SignatureTypeFormEnumForUpgrade typeform,
        ...
        String appID = getPropertyRequired(
                AfirmaServerSignatureServerPlugin.APPLICATIONID_SENSE_SEGELLLAT_DE_TEMPS_PROPERTY);
